...
import { Home, Edit3, FileText, Zap, LogOut, Sun, Moon, User, Settings, Brain } from 'lucide-react';
...
const Sidebar = ({ userSession }) => {
  const navItems = [
    ...
    { to: "/manage-techniques", icon: Brain, label: "Gerenciar Técnicas" },
  ];
  ...
  return (
    <motion.aside 
      className="w-60 bg-slate-800 p-5 space-y-6 shadow-xl fixed top-16 bottom-0 left-0 overflow-y-auto z-30 custom-scrollbar"
      initial={{ x: -240 }}
      animate={{ x: 0 }}
